...
export default function Pricing() {
  ...
  const paymentMethods = [
    ...
    { name: "کارت به کارت", icon: "card", details: "شماره کارت: ۱۲۳۴-۵۶۷۸-۹۰۱۲-۳۴۵۶" },
  ...
  const FAQ = [
    { q: "آیا امکان پرداخت اقساط وجود دارد؟", a: "بله، برای دورههای طولانیتر (بیش از ۲۰ جلسه) امکان پرداخت اقساط ماهانه را دارید. کافیست با ما تماس بگیرید." },
    ...
    { q: "آیا گواهی معتبر دریافت میکنم؟", a: "بله، پس از پایان موفق دوره و انجام آزمون نهایی، گواهی حضور و موفقیت با امضای رسمی دریافت میکنید." },
    ...
    <div className="min-h-screen">
      ...
      <Section variant="navy" className="relative overflow-hidden">
        <div className="max-w-6xl mx-auto text-center">
          <Badge variant="red" className="mb-6">قیمتگذاری</Badge>
