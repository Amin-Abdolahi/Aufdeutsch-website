...
export default function About() {
  ...
  const milestones = [
    ...
    { year: 2026, title: "توسعه پلتفرم یادگیری", description: "پیادهسازی سیستم تمرینات آنلاین" },
  ];

  const values = [
    {
      title: "شخصیسازی",
      description: "هر برنامهی درسی دقیقاً متناسب با اهداف، سطح و سبک یادگیری شما طراحی میشود.",
    },
    {
      title: "کیفیت",
      description: "استفاده از منابع معتبر و روشهای تدریس اثباتشده برای بهترین نتایج.",
    },
    {
      title: "پشتیبانی",
      description: "همراهی مستمر در طول مسیر یادگیری، پاسخگویی به سوالات و ارائه بازخورد.",
    },
    {
      title: "تعهد",
