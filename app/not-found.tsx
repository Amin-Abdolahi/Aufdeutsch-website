        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <div className="bg-paper-100 p-8 md:p-12 rounded-sm shadow-2xl max-w-2xl mx-auto relative -rotate-1">
            ...
            <p className="text-navy-900/70 mb-8 leading-relaxed">
              متأسفانه صفحه مورد نظر شما وجود ندارد یا حذف شده است.
              شاید آدرس را اشتباه وارد کردهاید یا این صفحه منتقل شده باشد.
            </p>
          ...
          {/* Help Text */}
          <p className="text-paper-100/60 mt-8 text-sm">
            اگر فکر میکنید این یک خطا است، لطفاً با ما تماس بگیرید.
          </p>
        </div>
      </Section>
    </div>
...
// Set metadata for 404 page
export const metadata = {
  title: "صفحه یافت نشد - AUF Deutsch",
  description: "متأسفانه صفحه مورد نظر شما وجود ندارد",
};