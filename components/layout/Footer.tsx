...
export function Footer() {
  ...
  const footerLinks = {
    courses: [
      { label: "مبتدی (A1-A2)", href: "/courses?level=a1" },
      { label: "متوسط (B1-B2)", href: "/courses?level=b1" },
      { label: "پیشرفته (C1)", href: "/courses?level=c1" },
      { label: "آمادگی آزمون", href: "/courses?type=exam" },
    ],
    company: [
      { label: "درباره ما", href: "/about" },
      { label: "قیمتگذاری", href: "/pricing" },
    ...
    support: [
      ...
      { label: "انصراف و بازگشت", href: "/refund" },
    ],
  };

  const socialLinks = [
    { name: "اینستاگرام", url: "https://instagram.com/aufdeutsch", icon: "instagram" },
    { name: "تلگرام", url: "https://t.me/aufdeutsch", icon: "telegram" },
    { name: "یوتیوب", url: "https://youtube.com/@aufdeutsch", icon: "youtube" },
  ];
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-paper-100/60 text-sm leading-relaxed mb-6">
              آموزش زبان آلمانی با روشی متفاوت. از صفر تا B1 در ۶ ماه، همراه با مدرسین مجرب.
            </p>
            {/* Social Links */}
          ...
          {/* Company Links */}
          <div>
            <h3 className="font-bold text-gold-500 mb-4">شرکت</h3>
            <ul className="space-y-2">
          ...
          {/* Support Links */}
          <div>
            <h3 className="font-bold text-gold-500 mb-4">پشتیبانی</h3>
            <ul className="space-y-2">
        ...
        <div className="border-t border-navy-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-paper-100/40 text-sm">
            © {currentYear} AUF Deutsch. تمامی حقوق محفوظ است.
          </p>
          <p className="text-paper-100/40 text-sm font-mono">
            ساخته شده با ♥ برای زبان آلمانی
          </p>
        </div>
      </div>
    </footer>
